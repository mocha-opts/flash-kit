...
const baseServerEnvSchema = z.object({
  ...
  STRIPE_PRODUCT_PRO_MONTHLY: z.string().optional(),
  STRIPE_PRICE_PRO_MONTHLY: z.string().optional(),
  STRIPE_PRODUCT_PRO_YEARLY: z.string().optional(),
  STRIPE_PRICE_PRO_YEARLY: z.string().optional(),
  STRIPE_PRODUCT_LIFETIME: z.string().optional(),
  STRIPE_PRICE_LIFETIME: z.string().optional(),
  STRIPE_PRODUCT_CREDIT_PACK_100: z.string().optional(),
  STRIPE_PRICE_CREDIT_PACK_100: z.string().optional(),
  ...
  POLAR_PRICE_LIFETIME: z.string().optional(),
  POLAR_PRODUCT_CREDIT_PACK_100: z.string().optional(),
  POLAR_PRICE_CREDIT_PACK_100: z.string().optional(),
